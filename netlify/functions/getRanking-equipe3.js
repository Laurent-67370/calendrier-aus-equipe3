...
// --- DONNÉES DE DÉPART ---
const playersData = [ 
    { id: 1, name: 'Philippe' }, { id: 2, name: 'Jean-Pierre THEODIN' }, { id: 3, name: 'Bernard Wolf' }, 
    { id: 4, name: 'Julien' }, { id: 5, name: 'Laurent Husser' }, { id: 6, name: 'Christine Pontida' }
];
const initialMatchesData = [
    { id: 'J1', journee: 1, homeTeam: 'OSTWALD ST OSWALD 5', awayTeam: 'ALSATIA UNITAS SCHILTIGHEIM 3', date: '2025-09-18', time: '20h00', venue: 'away', month: 'september' },
    { id: 'J2', journee: 2, homeTeam: 'ALSATIA UNITAS SCHILTIGHEIM 3', awayTeam: 'STBG ST JEAN 6', date: '2025-10-02', time: '20h15', venue: 'home', month: 'october' },
    { id: 'J3', journee: 3, homeTeam: 'ALSATIA UNITAS SCHILTIGHEIM 3', awayTeam: 'STBG CTS 4', date: '2025-10-16', time: '20h15', venue: 'home', month: 'october' },
    { id: 'J4', journee: 4, homeTeam: 'STBG RACING CLUB 3', awayTeam: 'ALSATIA UNITAS SCHILTIGHEIM 3', date: '2025-10-31', time: '20h15', venue: 'away', month: 'october' },
    { id: 'J5', journee: 5, homeTeam: 'ALSATIA UNITAS SCHILTIGHEIM 3', awayTeam: 'BISCHHEIM CHEMINOTS T.T. 2', date: '2025-11-20', time: '20h15', venue: 'home', month: 'november' },
    { id: 'J6', journee: 6, homeTeam: 'OSTWALD ST OSWALD 7', awayTeam: 'ALSATIA UNITAS SCHILTIGHEIM 3', date: '2025-12-05', time: '20h00', venue: 'away', month: 'december' },
    { id: 'J7', journee: 7, homeTeam: 'ALSATIA UNITAS SCHILTIGHEIM 3', awayTeam: 'VENDENHEIM ENVOLEE 6', date: '2025-12-18', time: '20h15', venue: 'home', month: 'december' }
];
// NOUVEAU : Données du classement basées sur votre image
...
// --- Le reste du script est identique mais gère maintenant 3 collections ---
  ...
  try {
    ...
    if (matchesSnapshot.empty) {
        ...
        initialMatchesData.forEach(match => {
            ...
            matchesBatch.set(matchesCollection.doc(id), { ...matchData, composition: { available: [], unavailable: [], noresponse: playersData.map(p=>p.id), selected: [] }, score: { alsatia: 0, opponent: 0 } });
        });
    ...
    // NOUVEAU : Initialisation du classement
    ...
    if (rankingSnapshot.empty) {
        ...
        initialRankingData.forEach(team => {
            rankingBatch.set(rankingCollection.doc(), team); // Utilise un ID auto-généré
        });
